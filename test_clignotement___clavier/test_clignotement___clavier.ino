...
void setup() {
  ...
  pinMode(relaiscirculation, OUTPUT); //Définir la broche du relais comme sortie
...
void loop()
{
  ...
  digitalWrite (relaiscirculation , etatcirculation);        //on met physiquement le relais dans la bonne position
}
